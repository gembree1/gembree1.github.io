// ALL code for linegraph is contained here

function linegraph_main() {

    var svg = d3.select("#linegraph_container")
        .insert("svg").attr("width", 960).attr("height", 500),
        margin = {
            top: 30,
            right: 80,
            bottom: 30,
    ...
    d3.json("data1.json", function(error, data) {
        ...
        g.append("g")
            ...
            .call(d3.axisRight(y2).ticks(12).tickFormat(function(d) {
                return parseInt(d);
            }))
            .append("text")
            .attr("class", "axis-title")
        ...
        svg.append("rect")
            ...
            }) // "initial" gives the default display attribute
        ...
        var legend = d3.select("#linegraph_container").append("svg")
            .attr("class", "legend")
            .attr("width", 150)
            .attr("height", 100)
            .selectAll("g")
