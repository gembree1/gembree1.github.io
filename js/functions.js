...
function renderBars(color, data) {
  ...
  x1.domain(array.map(function(d) {return d.id;})); //
  y1.domain([0, d3.max(Object.values(data), function(d) {return d;})]); //
  ...
  annot.enter().append("text")
        ...
        .attr("class", "barlabel")
        .attr("x", function(d) { return x1(d.id) + x.bandwidth()/2; })//
...
function renderBars(color, data) {
  ...
  annot.enter().append("text")
        ...
        .text(function(d) {return d3.format(",")(d.value);})
        .attr("class", "barlabel")
        .attr("x", function(d) { return x1(d.id) + x1.bandwidth()/2; })//
        .attr("y", function(d) { return y1(d.value) - 5; });//
}
